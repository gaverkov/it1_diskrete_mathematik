...
\begin{tabular}{|p{0.5\textwidth}|p{0.5\textwidth}|}
	...
	\emph{Rechner.} Speichermodell, Prozessor mit seinen Grundbefehlen. Ein- und Ausgabe-Geräte. \\
	\hline
	\emph{Rechenmodell.} & \emph{Betriebssystem}. Verwaltet die Ressourcen des Rechners, organisiert den Zugang zum Speicher und Geräten. Das Betriebssystem überführt sozusagen den Rechner in der rohen Form in ein freundlicheres Rechenmodell. 
	\\
	\hline
