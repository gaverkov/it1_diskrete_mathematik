...
\begin{bem} Einige Anwendungen der Breitensuche: 
	\begin{itemize} 
		...
		\item Die Generierung von Endspieldatenbanken im Schach basiert im Wesentlichen auf der Breitensuche. Vgl. den Abschnitt Generating Tablebases in  \url{https://en.wikipedia.org/wiki/Endgame_tablebase}. 
